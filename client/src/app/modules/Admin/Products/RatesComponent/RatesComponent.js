          ...
          <table className="table table-hover align-middle gs-0 gy-4">
            <thead>
              <tr className="text-center border-3 fw-bolder text-muted bg-light">
                ...
                <th className="ps-4 min-w-100px">Vendor Name</th>
                ...
                {!rates ? (
                  ...
                  rates.map((rate, index) => (
                    <tr className="text-center border-3 m-auto" key={rate._id}>
                      ...
                      <td className="border text-center">
                        <span>{rate.product  ? rate.product.user.fullname : ""}</span>
                      </td>
                      <td className="border text-center">
                        <span>{rate.product ? rate.product.title.en : ""}</span>
                      </td>
                      <td className="border text-center">
                        <select
                          name="myselect"
                          id="myselect"
                          defaultValue={rate.isApproved}
                          onChange={(e) => {
                ...
                {!rateQuery ? (
                  ...
                  rateQuery.map((rate, index) => (
                    <tr className="text-center border-3 m-auto" key={rate._id}>
                      ...
                      <td className="border text-center">
                        <span>{rate.product.user.fullname}</span>
                      </td>
                      <td className="border text-center">
