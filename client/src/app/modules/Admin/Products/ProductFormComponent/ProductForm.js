    ...
    <div className="d-flex flex-column-fluid">
      <div className="container">
        <div className="card card-custom">
              ...
              <ul className="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                ...
                >
                  ...
                  >
                    ...
                    <span className="nav-text font-size-lg">
                      {" "}
                      <FormattedMessage id="TABLE.PRODUCT.SECTION.1" />{" "}
                    </span>
                  </span>
                </li>
                <li
                ...
                >
                  ...
                  >
                    ...
                    <span className="nav-text font-size-lg">
                      {" "}
                      <FormattedMessage id="TABLE.PRODUCT.SECTION.2" />{" "}
                    </span>
                  </span>
                </li>
              </ul>
          ...
          <CardHeader selected={selected} prodInfo={prodInfo} />
        </div>
      </div>
    </div>
  );
