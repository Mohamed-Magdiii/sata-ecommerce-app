    ...
    <div className="d-flex flex-column-fluid">
      <div className="container">
        <div className="card card-custom">
          <div className="card-header card-header-tabs-line nav-tabs-line-3x">
            <div className="card-toolbar">
              <ul className="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                ...
                >
                  <span
                    className={`nav-link cursor-pointer ${selected ===
                      "Profile" && "active"}`}
                    data-toggle="tab"
                  >
                    ...
                    <span className="nav-text font-size-lg">
                      <FormattedMessage id="BUTTON.VENDOR.PROFILE" />
                    </span>
                  </span>
                </li>
                <li
                ...
                >
                  ...
                  >
                    ...
                    <span className="nav-text font-size-lg">
                      <FormattedMessage id="BUTTON.VENDOR.ACCOUNT" />
                    </span>
                  </span>
                </li>
                <li
                  className="nav-item mr-3"
                  onClick={() => setSelected("ChangePasword")}
                >
                  <span
                    className={`nav-link cursor-pointer ${selected ===
                      "ChangePasword" && "active"}`}
                    data-toggle="tab"
                  >
                    <span className="nav-icon">
                      <span className="svg-icon">
          ...
          <UrlContext.Provider value={match.params.role}>
