                      ...
                      >
                        {i === 0 ? (
                          ...
                          <span className="text-primary font-weight-bolder d-block font-size-lg">
                            <Moment
                              date={new Date(cell.render("Cell"))}
                              format="DD/MM/YYYY"
                            />
                          </span>
                        ) : i === 7 ? (
                          <>
                            <span
                              ...
                              onClick={() =>
                                history.push(
                                  `/admin/offers/offer-detail/${row.original._id}`
                                )
                              }
                            >
                          ...
                          <span className="text-danger ml-7 font-weight-bolder d-block font-size-lg">
                            {cell.render("Cell")}
                          </span>
                        ) : i === 6 ? (
